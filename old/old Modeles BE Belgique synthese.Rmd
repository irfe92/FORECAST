...
# Temp + cosinus + day_length + teff + t1 + t2 + t3 + t5 + t6 + t7 + Date + month + year + day + holidays + lagholidays + wday + quarter + season
...
# Temp + cosinus + day_length + t1 + t6 + t7 + Date + month + year + day + quarter
 
 
# COMPILATION des variables sélectionnées par regsubset : 
# Temp + cosinus + sinus + day_length + teff + t1 + t2 + t3 + t5 + t6 + t7 + Date + month + year + day + holidays + jc + lagholidays + wday + quarter + season
...
SP_BE=lm(Y~bs(X,df=4), data=donYX.train)
...
RF_BE<-randomForest(Y~., mtry = 11, ntree=400 ,data=don.train)
